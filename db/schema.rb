...
ActiveRecord::Schema.define(version: 20_190_325_112_113) do
  ...
  create_table 'friendships', force: :cascade do |t|
    ...
    t.index %w[friend_user_id user_id], name: 'index_friendships_on_friend_user_id_and_user_id', unique: true
    t.index %w[user_id friend_user_id], name: 'index_friendships_on_user_id_and_friend_user_id', unique: true
  end
