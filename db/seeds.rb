...
User.create!(email: 'admin@example.com', first_name: 'Bossy', last_name: 'McBosserton', password: 'password', role: :admin, email_confirmed: true)
User.create!(email: 'mackenzie@email.com', first_name: 'Mackenzie', last_name: 'f', password:  '1', role: :default, github_uid: '42525195', github_token: (ENV['MF_GITHUB_TOKEN']).to_s, github_handle: 'Mackenzie-Frey', github_url: 'https://github.com/Mackenzie-Frey', email_confirmed: true)
User.create!(email: 'april@email.com', first_name: 'April', last_name: 'D', password:  'test', role: :default, github_uid: '41272635', github_token: (ENV['GITHUB_API_KEY']).to_s, github_handle: 'aprildagonese', github_url: 'https://github.com/aprildagonese', email_confirmed: true)
User.create!(email: 'aaron@email.com', first_name: 'Aaron', last_name: 'R', password:  'test', role: :default, github_uid: '40776966', github_token: 'fake_token', github_handle: 'abroberts5', github_url: 'https://github.com/abroberts5', email_confirmed: true)
